...
def train_model(train_loader, val_loader,  model,  criterion, optimizer, device): # TAKE OUT num_epoch
    losses_epochs_train = []
    losses_epochs_val = []
...
def feature_map_statistics(model, test_dataset):
    ...
    percentage = {'L0': 0, 'L1': 0, 'L5': 0, 'L8': 0, 'L14': 0}  # dict to store the percentage for each feature map
    ...
    empirical_covariance = {'L0': 0, 'L1': 0, 'L5': 0, 'L8': 0, 'L14': 0}  # dict to store the empirical covariance matrix over the channels
    n = 0
